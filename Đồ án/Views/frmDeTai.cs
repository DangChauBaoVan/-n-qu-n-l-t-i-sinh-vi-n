...
namespace Đồ_án.Views
{
    public partial class frmDeTai : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'doanLTWDataSet_GiaoVien.GiaoVien' table. You can move, or remove it, as needed.
            this.giaoVienTableAdapter.Fill(this.doanLTWDataSet_GiaoVien.GiaoVien);
